...
class GameView(arcade.View):
    ...
    def process_keychange(self):
        ...
        if self.attack_key_pressed:
            for x in range(12):
                player_bullet = arcade.Sprite("sprites/energy -1.png.png", 0.05)
                ...
                if self.player_face_direction == RIGHT_FACING:
                    ...
                    player_bullet.center_y = p_start_y - 30 + 8 * random.randint(2, 5)
                    player_bullet.change_x = BULLET_SPEED + random.randint(-2, 2) / 5
                    player_bullet.change_y = random.randint(-5, 5) / 10

                elif self.player_face_direction == LEFT_FACING:

                    player_bullet.center_x = p_start_x - 30
                    player_bullet.center_y = p_start_y - 30 + 8 * self.list[random.randint(0, 4)]
                    player_bullet.change_x = -BULLET_SPEED + self.other_list[random.randint(0, 4)]
                    player_bullet.change_y = self.bullet_spread[random.randint(0, 4)]
        ...
        if self.challenger_attack_key_pressed:
            challenger_bullet = arcade.Sprite("sprites/energy -1.png.png", 0.25)
            ...
            if self.challenger_face_direction == 0:
                ...
                challenger_bullet.change_x = BULLET_SPEED
